...
<g:form action="boxReturn">
    ...
    <div class="buttons">
        <span class="button"><g:actionSubmit action="Annulla" class="nonfatto" value="Annulla"/></span>
        <span class="button"><g:actionSubmit action="Conferma" class="fatto" value="Conferma"/></span>
    </div>
</g:form>
